          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left z-10">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-100/80 border border-purple-300/80 text-purple-900 text-xs sm:text-sm font-extrabold shadow-sm"
              >
              ...
              <motion.p 
                ...
                className="text-gray-700 text-base sm:text-lg max-w-xl leading-relaxed font-medium"
              >
                You have <span className="font-extrabold text-purple-700">3 new brand deal invites</span> from Boat & Myntra matching your Lifestyle & Beauty niche!
              </motion.p>

              {/* Creator Live Stats Bar */}
              <div className="grid grid-cols-3 gap-3 max-w-lg pt-1">
                <div className="p-3.5 rounded-2xl bg-white border border-purple-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Total Earnings</p>
                  <p className="text-lg sm:text-xl font-black text-emerald-600">$3,200</p>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-purple-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Active Deals</p>
                  <p className="text-lg sm:text-xl font-black text-purple-700">2 Deals</p>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-purple-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Approval Rate</p>
                  <p className="text-lg sm:text-xl font-black text-indigo-600">94%</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-6 py-4 rounded-xl border-2 border-purple-300 bg-white hover:bg-purple-50 text-purple-700 font-bold text-sm sm:text-base shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-sm p-6 rounded-3xl bg-white border-2 border-purple-200 shadow-2xl space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-gray-900 flex items-center gap-1.5">
                      Sejal Sharma <CheckCircle2 className="w-4 h-4 text-purple-600 fill-purple-100" />
                    </h3>
                    <p className="text-xs font-semibold text-purple-600">@sejal_lifestyle • 95K Followers</p>
                ...
                <div className="p-3.5 rounded-2xl bg-purple-50 border border-purple-200/80 space-y-2">
                  <p className="text-xs font-extrabold text-purple-900 uppercase">🔥 Incoming Brand Offer</p>
                  <p className="text-xs text-gray-700 font-medium">
                    <strong className="text-gray-900">BoAt Lifestyle</strong> sent a $1,200 invitation for wireless earbuds campaign.
                  </p>
                  <button 
                    onClick={onOpenFeedModal}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left z-10">
              <motion.div 
                initial={{ opacity: 0, y: 15 }}
                animate={{ opacity: 1, y: 0 }}
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-100/80 border border-indigo-300/80 text-indigo-900 text-xs sm:text-sm font-extrabold shadow-sm"
              >
              ...
              <motion.p 
                ...
                className="text-gray-700 text-base sm:text-lg max-w-xl leading-relaxed font-medium"
              >
                Your active campaign <span className="font-extrabold text-indigo-700">&apos;Tech Unboxing 2026&apos;</span> has received <span className="font-extrabold text-purple-700">18 creator applications</span> today!
              </motion.p>

              {/* Business Live Stats Bar */}
              <div className="grid grid-cols-3 gap-3 max-w-lg pt-1">
                <div className="p-3.5 rounded-2xl bg-white border border-indigo-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Campaign Budget</p>
                  <p className="text-lg sm:text-xl font-black text-indigo-700">$15,000</p>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-indigo-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Active Campaigns</p>
                  <p className="text-lg sm:text-xl font-black text-purple-700">3 Live</p>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-indigo-200/80 shadow-md">
                  <p className="text-[10px] text-gray-500 font-bold uppercase">Total Audience Reach</p>
                  <p className="text-lg sm:text-xl font-black text-emerald-600">1.4M Reach</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-6 py-4 rounded-xl border-2 border-indigo-300 bg-white hover:bg-indigo-50 text-indigo-700 font-bold text-sm sm:text-base shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-sm p-6 rounded-3xl bg-white border-2 border-indigo-200 shadow-2xl space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-gray-900 flex items-center gap-1.5">
                      Nikhil <CheckCircle2 className="w-4 h-4 text-indigo-600 fill-indigo-100" />
                    </h3>
                    <p className="text-xs font-semibold text-indigo-600">Technikh Media • Verified Manager</p>
                    <p className="text-xs text-gray-500 font-medium mt-1">Verified Corporate Account</p>
                  </div>
                </div>

                <div className="p-3.5 rounded-2xl bg-indigo-50 border border-indigo-200/80 space-y-2">
                  <p className="text-xs font-extrabold text-indigo-900 uppercase">⚡ Top Creator Applicant</p>
                  <p className="text-xs text-gray-700 font-medium">
                    <strong className="text-gray-900">Rohan Verma (120K Tech)</strong> applied to your Tech Unboxing campaign.
                  </p>
                  <button 
                    onClick={onOpenFeedModal}
